...
|---|---|---|
| CM actuelle | ROG MAXIMUS XI HERO Z390 | ❌ Aucun blocage |
| Dongles Zigbee | 2× Sonoff ZBDongle-P, migrables tels quels | ❌ Aucun blocage |
| Onduleurs | SMT2200IC + BR900G-FR, NUT supportés | ❌ Aucun blocage |
