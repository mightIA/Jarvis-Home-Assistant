...
**Budget cible** : 2500 € (achat groupé)
...
| `00_Decisions_et_audits.md` | Décisions Mickael + résultats des 3 audits pré-achat | ✅ |
| `01_Architecture_cible.md` | Schéma architecture, rôles machines, communication | ✅ |
| `02_BoM_finalisee.md` | Bill of Materials détaillé avec prix et modèles précis | ✅ |
| `03_Phasage_A_a_G.md` | 7 phases d'exécution avec checklist | ⏳ à créer prochaine étape |
| `04_Risques_et_mitigations.md` | Tableau risques + plan rollback | ⏳ |
| `05_Onduleurs_NUT.md` | Config NUT/apcupsd Proxmox + PC | ⏳ |
| `06_Migration_HA_Pi5_Proxmox.md` | Procédure pas-à-pas migration HA | ⏳ |
| `07_Frigate_VM_Coral.md` | Sortie Frigate du Supervisor + passthrough Coral | ⏳ |
...
│                                 │         │  │   MQTT, Portainer,       │
│        🔋 BR900G-FR (540W)      │         │  │   Grafana, Uptime Kuma   │
...
## ⚠️ Points d'attention permanents
