...
- **Éditeur** : OpenAI
- **Versions** : DALL·E 3 (intégré ChatGPT, Bing/Copilot, API),
  **gpt-image-1** (depuis 2025, nouvelle gen multimodale, meilleur en
  texte et instruction-following)
- **Accès gratuit** : ChatGPT (limité), Microsoft Copilot (Bing Image
  Creator), Bing Image Creator standalone
