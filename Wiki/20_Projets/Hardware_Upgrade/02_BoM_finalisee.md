---
title: 02 — Bill of Materials finalisée
created: 2026-04-27
migrated_from: Projets/Hardware_Upgrade/02_BoM_finalisee.md
status: en-attente-phase-A-Hermes
phase: 0
budget_target: 2410 EUR
bloqueur: hermes-phase-1bis-d
tags: [projet, hardware, proxmox, ryzen, bom]
---
...
Voir `05_Onduleurs_NUT.md` pour la procédure détaillée.
...
**Tâche prochaine session** : remplir ce tableau avec les URLs et prix exacts du jour J pour la commande.
...
Fichier source intact : `Projets/Hardware_Upgrade/02_BoM_finalisee.md` (lecture seule pour ce vault).
