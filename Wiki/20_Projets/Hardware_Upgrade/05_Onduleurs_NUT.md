---
title: 05 — Onduleurs NUT et apcupsd
created: 2026-04-27
migrated_from: Projets/Hardware_Upgrade/05_Onduleurs_NUT.md
status: en-attente-phase-A-Hermes
phase: 0
budget_target: 2410 EUR
bloqueur: hermes-phase-1bis-d
tags: [projet, hardware, proxmox, ryzen, nut, onduleur]
---
...
> **Règle 0 sécurité** : générer 3 mots de passe forts distincts, stocker dans Vaultwarden (Phase G), JAMAIS commiter dans Git.
...
3. Vérifier dans `journalctl -u nut-monitor` : `On battery`
...
→ Achat **APC AP9631 Network Management Card 2** (~250 €).
...
Fichier source intact : `Projets/Hardware_Upgrade/05_Onduleurs_NUT.md` (lecture seule pour ce vault).
