...
# HA — Outils sidebar (barre latérale)

19 outils accessibles depuis la barre latérale de l'UI Home Assistant.
...
- [[Apps installées]] — chaque outil correspond à un add-on
- [[Modifications config]] — Outils de dev YAML pour rechargements
- Auto-memory : `reference_ha_sidebar_tools.md`

---

*Source : `Ressources/Competences/Home_Assistant.md` §12.*
