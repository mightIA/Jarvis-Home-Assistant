...
- **Home Assistant** (add-on `ha-mcp` via URL publique `https://mcp.might.ovh/private_PfjEvJTqhCdo9ELRqCPADlzo`) — 80+ outils `ha_*` pour toutes les actions HA (Cowork + CLI)
...
ha-mcp URL `private_PfjEvJTqhCdo9ELRqCPADlzo` toujours présente — T#65
