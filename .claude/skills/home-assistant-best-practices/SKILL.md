...
> **Source amont** : https://github.com/homeassistant-ai/skills (MIT, branche `main` — extraction du 2026-04-07)
> **Note Jarvis** : skill installé tel quel, pas d'adaptation à la config Mickael (le contenu est générique HA).
